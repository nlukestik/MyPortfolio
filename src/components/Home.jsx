...
import { Link, Zoom, Slide } from '@material-ui/core'
    ...
    <div className={classes.root}>
      <div className={classes.iconsLinkContainer}>
          <div className={classes.iconContainer}>
            <Zoom in={true} timeout={ {enter: 800}} style={{}}>
      ...
      <Slide in={true} direction="left" timeout={{enter: 500}}>
        <div className={classes.titleContainer}>
          <h1 className={classes.title}>Nicolás Lukestik</h1>
        </div>
      </Slide>

      <Zoom in={true} timeout={{enter: 1000}} style={{transitionDelay:"200ms"}}>
